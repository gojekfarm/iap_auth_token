...
RSpec.describe IapAuthenticator::Pkey do
	it 'should be able to handle invalid key' do
		expect { IapAuthenticator::Pkey.parse("") }.to raise_error('Invalid Private Key in service account credentials.')
	end

	it 'should parse RSA key' do
		key = OpenSSL::PKey::RSA.generate(2048)
		parsed_key = IapAuthenticator::Pkey.parse(key)
